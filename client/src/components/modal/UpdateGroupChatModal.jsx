...
const UpdateGroupChatModal = ({ fetchAgain, setFetchAgain, fetchMessages }) => {
  ...
  const handleAddUser = async (addUser) => {
    ...
    try {
      ...
      const response = await fetch("/api/chat/group/add", {
        method: "PUT",
        headers: {
  ...
  const handleRemove = async (removeUser) => {
    ...
    try {
      ...
      const response = await fetch("/api/chat/group/remove", {
        method: "PUT",
        headers: {
          Authorization: `Bearer ${user.token}`,
          "Content-Type": "application/json",
  ...
  const handleRename = async () => {
    ...
    try {
      ...
      const response = await fetch("/api/chat/group/rename", {
        method: "PUT",
        headers: {
          Authorization: `Bearer ${user.token}`,
          "Content-Type": "application/json",
  ...
  const handleSearch = async (query) => {
    ...
    try {
      ...
      const response = await fetch(`/api/user/search?key=${search}`, {
        method: "GET",
        headers: {
          Authorization: `Bearer ${user.token}`,
        },
